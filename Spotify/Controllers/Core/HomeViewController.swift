...
class HomeViewController: UIViewController {
    ...
    private func addLongGestureTap() {
    ...
    @objc func didLongPress(_ gesture: UILongPressGestureRecognizer) {
        ...
        actionSheet.addAction(UIAlertAction(title: "Add to Playlist", style: .default, handler: { [weak self] _ in
            DispatchQueue.main.async {
                ...
                vc.sectionHandler = { playlist in
                    APICaller.shared.addTrackToPlaylist(
                        track: model,
                        playlist: playlist
                    ) { success in
                        if success {
                            print("Here is the playlist: \(success)")
                        } else {
    ...
    private func fetchData() {
        ...
        var featuredPlaylists: FeaturePlaylistResponse?
        var reccomendations: RecommendationsResponse?
        ...
        APICaller.shared.getRecommendedGenres { result in
            switch result {
            case .success(let model):
                print("getRcommendedGenres Model: \(model)")
        ...
        group.notify(queue: .main) {
            ...
            guard let newAlbums = newReleases?.albums.items,
                  ...
                  let tracks = reccomendations?.tracks else {
