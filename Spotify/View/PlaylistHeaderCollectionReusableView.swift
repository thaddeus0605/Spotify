...
final class PlaylistHeaderCollectionReusableView: UICollectionReusableView {
    ...
    @objc private func didTapPlayAll() {
        delegate?.playlistHeaderCollectionReusableDidTapPlayAll(self)
    }
    ...
    override func layoutSubviews() {
        ...
        imageView.frame = CGRect(x: imageSize / 2, y: 20, width: imageSize, height: imageSize)
    ...
    func configure(with viewModel: PlaylistHeaderViewModel) {
        ...
        imageView.sd_setImage(with: viewModel.artworlURL, placeholderImage: UIImage(systemName: "photo"),completed: nil)
    }
}
